import 'package:coronavirus_app/resources/stylesmanager.dart';
...
//TextTheme
    textTheme: TextTheme(
      ...
      headline2:
          semiBoldTextStyle(color: ColorManager.white, fontSize: FontSize.s12),
      subtitle1:
          boldTextStyle(color: ColorManager.white, fontSize: FontSize.s28),
